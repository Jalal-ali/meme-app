...
const page = () => {
  ...
  return (
    <>
    <div className="pt-6 bg-gray-950 min-h-screen max-h-full ">

    <div className="flex justify-center">
<div className="items-center text-center">
    {meme ? <img className="shadow rounded min-w-1/3 max-w-56 justify-self-center" src={meme} alt="meme" /> : <div role="status">
    ...
    <span className="sr-only">Loading...</span>
      ...
      {renderInputFields()}
      <button className="focus:outline-none text-slate-200 bg-teal-800 hover:bg-teal-900 focus:ring-4 focus:ring-green-700 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" type="submit">Create</button>
    </form>    
    {download && <button  className="focus:outline-none text-slate-200 bg-indigo-800 hover:bg-indigo-900 focus:ring-4 focus:ring-green-700 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" onClick={downloadImage}>Download Meme</button>}
</div>
